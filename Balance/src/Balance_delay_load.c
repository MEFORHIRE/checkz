 ...
 */
FARPROC WINAPI BalanceDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = BalanceDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = BalanceDelayLoadWin32FailureHook;
#endif
